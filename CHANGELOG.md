...
- `withVirtualized` HOC for efficient rendering of large item lists (1000+ items) via windowed rendering (anchor index + edge-only window recentering fixes phantom rows / label drift)

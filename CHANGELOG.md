...
- `withVirtualized` HOC for efficient rendering of large item lists (1000+ items) via windowed rendering (anchor index, slice-update lock, debounced recenter, value-based index resolution)

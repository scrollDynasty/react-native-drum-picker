...
- `withVirtualized` HOC for efficient rendering of large item lists (1000+ items) via windowed rendering
- `enableScrollByTapOnItem` prop — tap any visible item to scroll it to the center position (Android + iOS)
